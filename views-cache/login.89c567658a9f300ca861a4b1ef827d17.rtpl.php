...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="estilo/../../plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index.php"><b>Admin</b>GR</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre para inicial sua sessão</p>
